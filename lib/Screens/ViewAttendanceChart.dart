...
class ViewAttendanceChart extends StatefulWidget {
  String mac;

  ViewAttendanceChart(this.mac);

  @override
  State<ViewAttendanceChart> createState() => _ViewAttendanceChartState();
}

class _ViewAttendanceChartState extends State<ViewAttendanceChart> {
